...
let ConvertToWorld = (index) => pointsClouds.geometry.vertices[index].clone().applyMatrix4(pointsClouds.matrixWorld)

let mod = (a,b) => a>=b ? 0.01 : -0.01;

let CreateCanvasMaterial = (color, size) => {
...
let DustGeometry = new THREE.Geometry(); /*	NO ONE SAID ANYTHING ABOUT MATH! UGH!	*/
const bg_particles_count = 1000; /* Leagues under the sea */
